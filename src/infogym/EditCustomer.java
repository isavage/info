...
public class EditCustomer extends javax.swing.JFrame {
    ...
    public EditCustomer(int id) {
        initComponents();
          ...
          Customer cust = new CustomerDBHelper().getCustomer(id);
          showCustomer(cust);
    ...
    private void showCustomer(Customer cust){
        jTextField11.setText(cust.getFirst_name());
        jTextField10.setText(cust.getLast_name());
        jTextField15.setText(cust.getTel());
        jTextField16.setText(cust.getMobile());
       
        int membIndex = Helpers.findIndex(jComboBox1, cust.getMembership().getName());
        System.out.println(membIndex);
        //jTextField1.setText(cust.getEmailId());
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new EditCustomer(6).setVisible(true);
            }
        });
    }
